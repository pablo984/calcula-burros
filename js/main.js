...
const botonDolar = document.getElementById("boton-dolar");
...
botonDolar.addEventListener("click", irACompraVentaDeDolares);
botonAyuda.addEventListener("click", irALaAyuda);
...
function irACompraVentaDeDolares(){
